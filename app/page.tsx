  ...
  return (
    <>
      <div className="z-10 w-full max-w-xl px-5 xl:px-0">
        ...
        <h1
          className="animate-fade-up bg-linear-to-br from-black to-stone-500 bg-clip-text text-center font-display text-4xl font-bold tracking-[-0.02em] text-transparent opacity-0 drop-shadow-xs [text-wrap:balance] md:text-7xl md:leading-[5rem]"
      ...
      <div className="my-10 grid w-full max-w-(--breakpoint-xl) animate-fade-up grid-cols-1 gap-5 px-5 md:grid-cols-3 xl:px-0">
